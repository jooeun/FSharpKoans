...
module ``about functions`` =
    ...
    let AddingTypeAnnotations() =
        ...
        // jooeun: can't call .Replace on text.

        //let sayItLikeAnAuctioneerWithoutTypeAnnotation text =
        //    text.Replace(" ", "")

        //let auctioneeredWithoutType = sayItLikeAnAuctioneerWithoutTypeAnnotation "going once going twice sold to the lady in red"
        //AssertEquality auctioneeredWithoutType "goingoncegoingtwicesoldtotheladyinred"
