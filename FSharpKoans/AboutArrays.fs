...
module ``about arrays`` =
    ...
    let CreatingArrays() =
        ...
        // I guess we can't do the int index with Lists in F#...
    ...
    let ArraysAreMutable() =
        ...
        // ARRAY ARE MUTABLE, BUT LISTS ARE NOT

        AssertEquality fruits [| "apple"; "peach" |] 
        AssertEquality fruits [ "apple"; "peach" ] // thought this would fail, but I guess not.
